      ...
      <div className=" w-[1215px]   relative top-36 left-[301.5px] flex flex-col gap-3">
        <div className="w-full h-[340px] rounded-md   border border-gray-500 flex items-center justify-center gap-10">
          <div className=" flex flex-col gap-5">
            <div className="flex flex-col gap-5">
              <h1 className="text-4xl text-mono">React JS & Redux</h1>
              <p className="text-base text-zinc-500">
                Xozirda mashhur JavaScript frameworklaridan biri ReactJSni
                to'liq o'rganing. ReactJS darslari <br /> to'liq kurs o'zbek
                tilida. ReactJS amaliyot va loyihalar. Ushbu kursda siz ReactJS
                ga oid barcha <br /> keraklik ko'nikmalarga ega bo'lasiz va
                hamma bilimlarni amaliy loyihalar yordamida <br />{" "}
                mustahkamlaysiz. Redux va Redux toolkit nima ekanligini va uni
                qanday qo'llash kerakligi haqida <br /> ham keraklik
                ma'lumotlarni ushbu kursda topishingiz mumkin, va albatta
                loyihalar yordamida <br /> bilimlarimizni mustahkamlaymiz.
              </p>
            </div>
            <div className="flex flex-col gap-5">
            ...
            <div className="w-full h-[250px] rounded-md  flex   pl-10 flex-col justify-center gap-4 border border-gray-500">
              ...
              <div className="grid grid-cols-2 grid-rows-5 gap-2">
                <p className="flex items-center  gap-2 text-xl">
                  <IoMdCheckmarkCircleOutline /> Class component
                </p>
                <p className="flex items-center  gap-2 text-xl">
                  <IoMdCheckmarkCircleOutline /> Function component
                </p>
                <p className="flex items-center  gap-2 text-xl">
                  <IoMdCheckmarkCircleOutline /> Hooklar
                </p>
                <p className="flex items-center  gap-2 text-xl">
                ...
                <p className="flex items-center  gap-2 text-xl">
                  <IoMdCheckmarkCircleOutline /> API bilan ishlash
                </p>
                <p className="flex items-center  gap-2 text-xl">
                  <IoMdCheckmarkCircleOutline /> Redux
                </p>
                <p className="flex items-center  gap-2 text-xl">
                  <IoMdCheckmarkCircleOutline /> Redux
                </p>
                <p className="flex items-center  gap-2 text-xl">
                  <IoMdCheckmarkCircleOutline /> Redux toolkit
                </p>
              </div>
            </div>
          </div>
